...
C<user>, C<userln>, C<unames>, C<ugroups>, C<ugnames>, C<udisp>. C<udispq>, C<uglist>, C<ldapLst>;
...
C<-banner>, C<-logo>, C<-icons>, C<-menuchs>, C<-menuchs1>, C<-frmLso>, C<-frmLsc>;
C<-login>;
C<-cgvXXX>;
...
(C<User Interface>)
User Interface forms list. Default will be generated from C<-form> and C<-table>.
...
=item recActLim (table name | {table meta} | {command}, {record}, ?{database record}, 'options', field name | -operation,... ) -> true || die
