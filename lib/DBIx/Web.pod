...
C<-host>, C<-recInsID>, C<-idsplit>, C<-wikn>
...
-loop   => boolean  or  -ddlbloop => boolean	# call C<recForm> after list box choice change
...
C<-recForm0R>, C<-recEdt0R>, <-recChg0R>, C<-recIns0R>, C<-recInsID>, C<-recChg0W>
...
C<-recUpd0R>, C<-recChg0W>, C<-recUpd1C>, C<-recForm1C> triggers.
