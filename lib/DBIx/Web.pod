...
C<-AuthUserFile>, C<-AuthGroupFile>, C<-ldap>, C<-w32ldap>;
C<-userln>, C<-usernt>, C<-udisp>;
C<-udflt>, C<-unflt>, C<-ugflt>, C<-ugadd>;

C<user>, C<userln>, C<unames>, C<ugroups>, C<ugnames>, C<udisp>, C<uglist>, C<ldapLst>;
C<ugrexp>, C<ugmember>, C<uguest>, C<uadmrdr>, C<uadmwtr>, C<uadmin>;
C<ugfile>;
C<w32IISdpsn>, C<w32adhi>, C<w32user>, C<w32umail>;
...
Using C<ugfile>(), C<-AuthGroupFile> and C<-AuthUserFile> should not be set.
This slots should be set only to externally controlled files.
I.e. to files produced via "$0 -call ugfile ugf_w32 0 q" C<Command Line>.
...
See source code for limitations and details.
