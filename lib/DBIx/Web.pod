...
=item ddvFTQuery () -> (Full-text search default view definition)

C<Default Data Definitions>.
Default definition for Full-text search page.
See inplementation for limitations and details.


=item ddvIndex () -> (Index page default view definition)

C<Default Data Definitions>.
Default definition for Index page enumerating all C<-menuchs> entries.
