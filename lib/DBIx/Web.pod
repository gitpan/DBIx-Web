...
Old values are not available in 'C'ommand triggers.
...
i.e. "web.cgi -reindex" or "web.cgi -setup".
Several command line options are implemented within C<cgiRun> method,
